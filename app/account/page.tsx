            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-3 border-b border-slate-200 dark:border-slate-700">
                    <div>
                      ...
                      <p className="text-slate-600 dark:text-slate-400">{user?.user_metadata?.full_name || "Not set"}</p>
                    </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between items-center mb-2">
                      <p className="font-medium text-slate-900 dark:text-white">Monthly Submissions</p>
                      <p className="text-slate-600 dark:text-slate-400">{stats.monthlySubmissions} / 50</p>
                    </div>
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div 
                        className="bg-blue-600 h-2 rounded-full transition-all duration-300"
                        style={{ width: `${Math.min((stats.monthlySubmissions / 50) * 100, 100)}%` }}
                      ></div>
                    </div>
                    <p className="text-sm text-slate-600 dark:text-slate-400 mt-1">
                      {Math.round((stats.monthlySubmissions / 50) * 100)}% of monthly submissions quota used
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="card p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-xl font-semibold text-slate-900 dark:text-white">LINKED EMAILS</h2>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    1 of 2 email addresses added. <span className="text-red-600 dark:text-red-400 font-medium">Upgrade</span> to add unlimited addresses.
                  </p>
                </div>
              </div>
              ...
              <div className="card p-6">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">Upgrade your account for:</h2>
