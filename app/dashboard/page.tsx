            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <div className="flex justify-between items-center h-16">
                ...
                <div className="md:hidden">
                  <button 
                    onClick={() => document.getElementById('dashboard-mobile-menu')?.classList.toggle('hidden')}
              ...
              {/* Mobile Menu */}
              <div id="dashboard-mobile-menu" className="hidden md:hidden py-2">
                <div className="flex flex-col space-y-2 bg-white dark:bg-slate-800 rounded-lg shadow-lg mt-2 border border-slate-200 dark:border-slate-700 p-3">
                  <span className="text-slate-600 dark:text-slate-300 text-sm px-3 py-1 border-b border-slate-200 dark:border-slate-700 pb-2">
                    Welcome, {user?.email}
                  </span>
                  <Link
                    href="/submissions"
                    ...
                    onClick={() => document.getElementById('dashboard-mobile-menu')?.classList.add('hidden')}
                  >
                    Submissions
                  </Link>
                  <Link
                  ...
                  <button
                    onClick={() => {
                      document.getElementById('dashboard-mobile-menu')?.classList.add('hidden');
                      handleLogout();
                    }}
                    className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-700 transition-colors"
                  >
                    Logout
                  </button>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="mb-8">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
                ...
                <Link href="/form-builder" className="btn-primary mt-4 sm:mt-0">
                  <svg
